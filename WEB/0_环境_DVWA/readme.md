...
![img_3.png](../Brute%20Force/img/img_3.png)

然后ctrl + r 发送给 repeater。修改报文，点send可以重复发包。render 可以查看reponse网页。

![img_4.png](../Brute%20Force/img/img_4.png)

ctrl + i 发送给 intruder。添加payload，攻击。

报文长度排序。

![img_5.png](../Brute%20Force/img/img_5.png)

![img_6.png](../Brute%20Force/img/img_6.png)

![img_7.png](../Brute%20Force/img/img_7.png)

## 2 Command Injection
命令注入。输入 127.0.0.1 点submit。等四秒出现以下。

![](../2_Command%20Injection/img/img_8.png)

同样 brupsuit intercept on。 输入127.0.0.1 后，查看报文。 ctrl + r 。

修改报文，可以执行 whoami dir 等命令。 ctrl + u 转换url编码。

![img.png](../2_Command%20Injection/img/img_9.png)
...
![img.png](../2_Command%20Injection/img/img11.png)

![img.png](../2_Command%20Injection/img/img10.png)

使用antsword连接。

github 下载antsword。

![img.png](../2_Command%20Injection/img/img12.png)

如果执行命令行 会被defend杀。

![img.png](../2_Command%20Injection/img/img13.png)

## 3 file inclusion file upload 文件上传与文件包含

文件包含： 观察url 盲猜 file4

![img.png](../3_file%20inclusion%20upload/img/img14.png)

----

文件上传： 上传webshell（jpg 直接写）,

![img.png](../3_file%20inclusion%20upload/img/img15.png)

![img.png](../3_file%20inclusion%20upload/img/img16.png)


 结合上一步盲猜url（加 ..\ ） 拿到url，上antsword。

![img.png](../3_file%20inclusion%20upload/img/img17.png)

返回为空。 需要添加cookie，brupsuit拦截报文。添加请求信息。

![img.png](../3_file%20inclusion%20upload/img/img18.png)

![img.png](../3_file%20inclusion%20upload/img/img20.png)

![img.png](../3_file%20inclusion%20upload/img/img19.png)
...
![img.png](../4_SQL%20Injection/img/img21.png)
...
![img.png](../4_SQL%20Injection/img/img22.png)
...
![img.png](../4_SQL%20Injection/img/img23.png)
...
![img.png](../4_SQL%20Injection/img/img24.png)

得到结果，ASCII解码。

![img.png](../4_SQL%20Injection/img/img25.png)
...
![img.png](../4_SQL%20Injection/img/img26.png)

查询数据。

    SELECT+GROUP_CONCAT(user,":",password+SEPARATOR+0x3c62723e)+FROM+dvwa.users

![img.png](../4_SQL%20Injection/img/img27.png)
---
### sqlmap自动化注入
...
![img.png](../4_SQL%20Injection/img/img28.png)
...
![img.png](../4_SQL%20Injection/img/img29.png)

![img.png](../4_SQL%20Injection/img/img30.png)